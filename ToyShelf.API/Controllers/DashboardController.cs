...
namespace ToyShelf.API.Controllers
{
	...
	public class DashboardController : ControllerBase
	{
		...
		public async Task<BaseResponse<WarehouseStatCardResponse>> GetWarehouseStatCard(
			Guid warehouseId, [FromQuery] DateTime? FromDate, [FromQuery] DateTime? ToDate
            )
		{
			var result = await _dashboardService.GetWarehouseStatCardAsync(warehouseId, FromDate, ToDate);
