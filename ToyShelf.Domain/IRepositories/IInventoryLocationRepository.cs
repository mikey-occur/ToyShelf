...
namespace ToyShelf.Domain.IRepositories
{
	public interface IInventoryLocationRepository : IGenericRepository<InventoryLocation>
	{
		...
		Task<List<InventoryLocation>> GetInventoryLocationsAsync(bool? isActive, Guid? StoreId, Guid? WarehouseId, string? locationType = null, Guid? partnerId = null);
		Task<InventoryLocation?> GetStoreLocationByStoreIdAsync(Guid storeId);
		Task<List<InventoryLocation>> GetWarehouseLocationsByCityAsync(Guid cityId);
	}
}
